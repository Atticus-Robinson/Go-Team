  ...
  <h1 class="text-center text-white">My Team</h1>    
      ...
      ${data
        ...
        <div class="card-body bg-success bg-opacity-25">
          <h5 class="card-title text-center">${data.getName()}</h5>
          <p class="card-text text-center"><i class="bi bi-building"></i> ${data.getRole()}</p>
        </div>
        <ul class="list-group list-group-flush">
          <li class="list-group-item text-center">ID: ${data.getId()}</li>
          <li class="list-group-item text-center">Email: <a href="mailto:${data.getEmail()}">${data.getEmail()}</a></li>
      ...
      ${data
        ...
        .map((data) => {
          ...
          <div class="card-body bg-danger bg-opacity-25">
            <h5 class="card-title text-center">${data.getName()}</h5>
            <p class="card-text text-center"><i class="bi bi-tools"></i> ${data.getRole()}</p>
          </div>
          <ul class="list-group list-group-flush">
            <li class="list-group-item text-center">ID: ${data.getId()}</li>
            <li class="list-group-item text-center">Email: <a href="mailto:${data.getEmail()}">${data.getEmail()}</a></li>
      ...
      ${data
        ...
        .map((data) => {
          ...
          <div class="card-body bg-primary bg-opacity-25">
            <h5 class="card-title text-center">${data.getName()}</h5>
            <p class="card-text text-center"><i class="bi bi-data-circle"></i> ${data.getRole()}</p>
          </div>
          <ul class="list-group list-group-flush">
            <li class="list-group-item text-center">ID: ${data.getId()}</li>
            <li class="list-group-item text-center">Email: <a href="mailto:${data.getEmail()}">${data.getEmail()}</a></li>
            <li class="list-group-item text-center">School: ${data.getSchool()}</li>
          </ul>
        </div>`;
        })}
        </main>
